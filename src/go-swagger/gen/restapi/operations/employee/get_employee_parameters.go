...
func (o *GetEmployeeParams) bindEmployeeID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetEmployeeParams) validateEmployeeID(formats strfmt.Registry) error {
